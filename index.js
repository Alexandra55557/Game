...
function gameOver(a) {
    var gameOverAlertElement = "<b>Игра закончена!!!</b><br><br> Игрок " + span[a].dataset.player.toUpperCase() + ' Победил!!! <br><br>' + restartButton;
...
function draw() {
    var drawAlertElement = '<b>Начать сначала!!!</b><br><br>' + restartButton;
    var div = document.createElement("div");
    div.className = "alert";
